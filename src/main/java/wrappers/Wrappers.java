...
public interface Wrappers {
	...
	/**
	 * This method will set a wait time in milli seconds for a web driver
	 * @param millis
	 */
	public void waitProperty(long millis);
	
	/**
	 * This method will scroll the web page down
	 */
	public void pageDown();
	
	/**
	 * This method will mouse hover on element provided by xpath
	 * @param xpath
	 */
	public void mouseHoverByXpath(String xpath);
	
	/**
	 * This method will perform mouse hover and click on the given locator
	 * @param xpath - xpath of the element to perform mouse hover and click
	 */
